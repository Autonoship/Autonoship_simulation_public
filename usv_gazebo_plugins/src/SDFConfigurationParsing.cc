...
bool parseVariableNamesSDFElement(sdf::ElementPtr sdf_elem, 
                                  const std::vector<std::string>& defaultInputVariableNames, std::vector<std::string>& inputVariableNames, 
                                  const std::vector<std::string>& defaulOutputVariableNames, std::vector<std::string>& outputVariableName, 
                                  const std::vector<std::string>& defaultTunableParameterNames, std::vector<std::string>& tunableParameterNames)
{
  bool ok = true;
  ok = ok && parseVariableNamesSDFElementHelper(sdf_elem, defaultInputVariableNames, inputVariableNames);
  ok = ok && parseVariableNamesSDFElementHelper(sdf_elem, defaultTunableParameterNames, tunableParameterNames);
