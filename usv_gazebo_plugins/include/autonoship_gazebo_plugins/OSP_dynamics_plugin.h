#ifndef OSP_DYNAMICS_H
#define OSP_DYNAMICS_H
...
namespace gazebo
{
  ...
  private:
    ...
    void UpdateTargetSpeed(const std_msgs::Float64 &target_speed);
    ...
    double target_speed_ = 0.0;  // rudder input for acceleration
