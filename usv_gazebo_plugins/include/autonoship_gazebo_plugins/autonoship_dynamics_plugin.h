...
#ifndef AUTONOSHIP_DYNAMICS_H
#define AUTONOSHIP_DYNAMICS_H
...
namespace gazebo
{
  class AutonoshipPlugin : public ModelPlugin
  {
  public:
    AutonoshipPlugin();
    virtual ~AutonoshipPlugin();
  ...
  };  // class AutonoshipPlugin
} // namespace gazebo

#endif //AUTONOSHIP_DYNAMICS_H
