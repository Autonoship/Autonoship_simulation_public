 ...
 * @param[in] defaultTunableParameterNames default names for output variables
 * @param[out] tunableParameterNames default names for output variables
...
bool parseVariableNamesSDFElement(sdf::ElementPtr sdf,
                                  ...
                                  const std::vector<std::string>& defaultTunableParameterNames,
                                  std::vector<std::string>& tunableParameterNames);
