...
namespace gazebo
{
    ...
    public:
        ...
        /// \brief Get tunable parameter references
        bool getTunableParameterRefs(const std::vector<std::string>& tunableParameterNames,
        ...
        bool setInputVariables(const std::vector<fmi2_value_reference_t>& inputVariableReferences, const std::vector<double>& inputVariables);

        /// \brief Set tunable parameters
        bool setTunableParameters(const std::vector<fmi2_value_reference_t>& parameterReferences,
                               const std::vector<double>& Parameters);

        /// \brief Get output variables
        bool getOutputVariables(const std::vector<fmi2_value_reference_t>& outputVariableReferences, std::vector<double>& outputVariables);
        /// \brief Unload
